...
var GoogleReCaptchaProvider = /** @class */ (function (_super) {
    ...
    function GoogleReCaptchaProvider() {
        ...
        _this.chinaRecaptchaSrc = 'https://www.recaptcha.net/recaptcha/api.js';
        ...
        _this.injectGoogleReCaptchaScript = function () {
            ...
            js.src = (language === 'zh' ? _this.chinaRecaptchaSrc : _this.googleRecaptchaSrc) + "?render=" + reCaptchaKey + (language ? "&hl=" + language : '');
